...
const uiTips = {
  "top-nav": {
    title: "Mini Brand Bar",
    what: "Logo and subtle brand anchors.",
    why: "Establishes identity without stealing focus.",
    tips: [
      "Keep it minimal.",
      "Use small logo size.",
  ...
  "profile": {
    title: "Profile Block",
    what: "Avatar, handle, and one-line bio.",
    why: "Trust and context before links.",
    tips: [
      "Keep copy short.",
  ...
  "handle": {
    title: "Handle / Name",
    what: "The public identifier.",
    why: "Confirms users are in the right place.",
    tips: [
      "Readable at small sizes.",
      "No fancy fonts for the handle."
    ]
  },
  "bio": {
    title: "Short Bio",
    what: "One sentence on who/what/why.",
    why: "Clarifies value quickly.",
    tips: [
  ...
  "highlight": {
    ...
    what: "Featured campaign/link at the top.",
    why: "Directs attention to the most important action.",
    tips: [
  ...
  "highlight-cta": {
    title: "Highlight CTA",
    what: "Primary action inside the highlight.",
    why: "Concentrates clicks.",
    tips: [
      "Outcome label.",
      "Large tap target.",
      "High contrast."
  ...
  "link-stack": {
    title: "Link Stack",
    what: "Vertical list of action buttons.",
    why: "Fast path to destinations.",
    tips: [
  ...
  "link-item": {
    title: "Link Button",
    what: "Single actionable link.",
    why: "Main interaction zone.",
    tips: [
      "Verb-led labels.",
  ...
  "link-badge": {
    title: "Badge (e.g., New)",
    what: "Tiny tag that changes priority.",
    why: "Highlights time-sensitive links.",
    tips: [
      "Use sparingly.",
      "High contrast but small."
    ]
  },
  "social-row": {
    title: "Social Icons",
    what: "Quick jump to social profiles.",
    why: "Reinforces identity & reach.",
    tips: [
      "Label icons for a11y.",
      "Keep count 3–6 to avoid clutter."
    ]
  },
  "social-icon": {
    title: "Social Icon",
    what: "Linked logo for a network.",
    why: "Familiar visual shortcut.",
    tips: [
  ...
  "promo-cover": {
    title: "Promo Cover",
    what: "Optional hero band for campaign visuals.",
    why: "Adds mood and context.",
    tips: [
      "Subtle motion OK.",
      "Don't overpower links."
    ]
  },
  "footer": {
    title: "Tiny Footer",
    what: "Legal/attribution line.",
